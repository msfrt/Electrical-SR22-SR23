...
class Screen {
    ...
    protected:
        ILI9341_t3n &display_;  ///< The low-level object that actually interfaces with the hardware
        EasyTimer frame_rate_timer_ = EasyTimer(10);  ///< Timer for screen updates, default at 10 Hz
