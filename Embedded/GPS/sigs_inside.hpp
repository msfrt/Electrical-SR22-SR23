...
// outgoing signals
StateSignal GPS_teensyTemp(16, true, 10, 0, -3276, 3276, 0);
StateSignal GPS_boardTemp(16, true, 10, 0, -3276, 3276, 0);
StateSignal GPS_laptrigger(8, true, 1, 0, 0, 100, 0, 500);
// Message: GPS_15 [0xa5]
